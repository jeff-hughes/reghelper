...
test_that('lm with 2 continuous int. works', {
    ...
    expect_equal(quo_name(graph$mapping$x), 'x1')
    expect_equal(quo_name(graph$mapping$y), 'y')
    expect_equal(quo_name(graph$mapping$colour), 'x2')
...
test_that('aov with 2-way interaction works', {
    ...
    expect_equal(quo_name(graph$mapping$x), 'x1')
    expect_equal(quo_name(graph$mapping$y), 'y')
    expect_equal(quo_name(graph$mapping$fill), 'x2')
